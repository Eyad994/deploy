...
class HomeController extends Controller
{
    ...
    public function send($title="title", $message="message", $device_token="cD2TXUjKYGM:APA91bGSL_mHxasAOeyenNFUcfvUBiQbuSzoQLwM4bJC9w79-uBh2cex3Y1ShULly8ojHvmC5y68qTlhgDFaodCBPVziDxFosFW-YkURhOhBgcii13LI-msBrnkeTyR3yJ_6vNS2imRx")
    {
    ...
    private function sendPushNotification($fields)
    {
        ...
        $headers = array(
            'Authorization: key=AAAAKveT9F8:APA91bGXgJ7wj_x92I4XqFg0wj6CPDNr-GCnxhs2U2esIIrV6Anqnd1NOn3nwAkNZWcNhR-Ll6fbsgnQegsoFpadL6FZoK_ZZzhglJtdd09qU0WNYypd1d1zQMeoLeZNR4Z-9-14smvy',
